...
def normalize_short_url(url: str) -> str:
    ...
    Haddii normalization-ku guuldarreeyo, dib u celi URL-kii asalka ahaa.
    """
    try:
...
def handle_video_url(message):
    ...
    # Haddii aad rabto kaliya TikTok:
    # if "tiktok.com" not in url:
    #     return bot.send_message(message.chat.id, "⚠️ Botkan wuxuu hadda kaliya taageeraa TikTok videos.")
    ...
    ydl_opts = {
        ...
        'ffmpeg_location': '/usr/bin/ffmpeg',  # Haddii FFmpeg uu ku jiro jid kala duwan, beddel halkan
    }
    ...
    try:
        ...
        # Nadiifi faylka haddii la abuuray
        try:
